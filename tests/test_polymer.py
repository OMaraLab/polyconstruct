...
def test_polymer():    
    ...
    while polymer.has_junction("A2"):
        if random.random() < 0.2:
            polymer.extend(arg_monomer, from_junction_name= 'A2', to_junction_name= 'C')
        else:
            polymer.extend(glu_monomer, from_junction_name= 'A2', to_junction_name= 'C')            
    ...
    polymer_topology.to_ITP('tests/samples/polymer.itp')
